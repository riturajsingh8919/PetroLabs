...
const CoreExpertiseSection = () => {
  ...
  return (
    <section className="relative bg-linear-to-b from-gray-50 via-white to-gray-50 min-h-screen overflow-hidden py-16">
      {/* Enhanced Wave Divider */}
      <div className="absolute top-0 left-0 w-full h-48 transform -translate-y-1">
        <svg
      ...
      <div className="container mx-auto px-4 md:px-10 lg:px-16 relative z-10">
        ...
        >
          ...
          <h2 className="font-heading text-4xl md:text-6xl xl:text-7xl font-black text-gray-900 mb-8 leading-tight">
            Empowering{" "}
            ...
            {expertiseData.map((item, index) => (
              ...
              >
                ...
                >
                  ...
                  <h3
                    className="font-heading text-2xl font-bold text-gray-900 mb-6 leading-tight relative z-10"
                  ...
                  <p
                    className="font-body text-gray-600 leading-relaxed relative z-10 text-lg"
